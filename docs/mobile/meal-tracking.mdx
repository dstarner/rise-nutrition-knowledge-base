...
# Meal Tracking in the Mobile App

Tracking your meals via Rise Nutrition gives your coaches, nutritionists, dietitians, and medical staff more
in-depth data points to optimize your performance. It is critical to track as much and as often as possible, to
ensure our current statistics and future recommendations are as accurate as possible.

## Adding a Meal

As an athlete, you can add food for yourself via the mobile app through the following process:

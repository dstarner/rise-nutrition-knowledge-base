...
# Goal Management via the Dashboard

A **Goal** in Rise Nutrition allows setting targets for an athlete to acheive in a certain area,
either through training or their nutrition.
...
On the dashboard home page, find the **Goals** panel and select the *Add* (`+`) icon in the top
right of the panel. This will take you to the goals page to create a new item. 
...
Once the goal is created, positions and individual athletes can be assigned to the goal. Once on

...
<ImageStepper>
  <ImageStepper.Step
    title="Add Goal"
    imgSrc="/img/docs/dashboard/goals/createGoal.png"
    imgCaption="Click the 'Add' (+) icon on the dashboard Goals panel"
  >

On the athlete profile page, find the **Goals** panel and select the *Add* (`+`) icon in the top right of the panel. This will take you to the goals page to create a new item.

  </ImageStepper.Step>
  <ImageStepper.Step
    title="Create New Goal"
    imgSrc="/img/docs/dashboard/goals/newGoal.png"
    imgCaption="View the goals page to see tracked items"
  >

Fill in the details of the goal as desired, once on the goal creation screen.

1. Summary Text: create a name for the new goal
2. Goal Variant: the goal type- either **nutrition** or **training** for filtering and resolution purposes
3. Detailed Description: provide more information for the athlete and other dashboard users
...
Once complete, clack "Track" to save the goal.

  </ImageStepper.Step>
</ImageStepper>

### Assign Athlete to a Goal
...
<ImageStepper>
  <ImageStepper.Step
    ...
    imgSrc="/img/docs/dashboard/goals/goalAssignment.png"
...
![Remove assignment](/img/docs/dashboard/goals/removeAssignment.png)

## Delete Goal

If you want to completely remove a goal, you can navigate to the Goal Details page, select the appropriate goal, and
select "Remove Goal".

![Delete goal](/img/docs/dashboard/goals/removeGoal.png)

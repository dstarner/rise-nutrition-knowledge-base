...
The time will autopopulate with the time food items are being entered. If foods items were not consumed at the time of entry, you can change the time by clicking the listed time shown in the top right of the meal box (1) and select the appropriate time (2). 
